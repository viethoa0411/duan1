    ...
    <div class="row flex-nowrap">
        ...
        <div class="col p-0">
            ...
            <div class="bg-primary text-white py-3 px-4">
                <h4 class="mb-0"><i class="bi bi-folder-plus"></i> Thêm danh mục mới</h4>
            </div>
            ...
            <div class="p-4">
                <form action="<?= BASE_URL_ADMIN . '?act=categories/add' ?>" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description" id="description" class="form-control" rows="3" placeholder="Nhập mô tả (không bắt buộc)"></textarea>
                    </div>
