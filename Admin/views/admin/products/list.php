...
<div class="container-fluid">
    <div class="row flex-nowrap">
        ...
        <div class="col py-3">
            ...
            <button type="button"><a href="<?=BASE_URL_ADMIN . '?act=formadd'?>">Thêm sản phẩm</a></button>
            <table border="1" cellpadding="8" cellspacing="0">
                ...
                <tr>
                    ...
                    <td><a href="<?=BASE_URL_ADMIN . '?act=products/edit&id=' . $product['id']?>" class="btn btn-warning btn-sm">Sửa</a></td>
