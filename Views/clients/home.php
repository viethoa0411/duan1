      ...
      <?php foreach ($products as $product): ?>
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="card h-100 shadow-sm border-0">
            ...
            ?>
            <a href="<?= BASE_URL . '?act=detail&id=' . $product['id'] ?>" class="text-decoration-none text-dark">
              <img src="/duan1/admin/uploads/products/<?= htmlspecialchars($imagePath) ?>"
                class="card-img-top"
                style="height: 250px; object-fit: cover;" alt="Ảnh sản phẩm">
              <div class="card-body">
        ...
        <?php foreach ($products_view as $product): ?>
          <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="card h-100 shadow-sm border-0">
              ...
              <a href="?act=detail&id=<?= $product['id'] ?>" class="text-decoration-none text-dark" style="display: block;">

                <?php
                // Tách để loại bỏ phần "uploads/products/" bị trùng (nếu có)
                $imagePath = str_replace('uploads/products/', '', $product['image']);
                ?>
                <!-- Đảm bảo ảnh có kích thước chuẩn và bao phủ toàn bộ -->
                <img src="/duan1/admin/uploads/products/<?= htmlspecialchars($imagePath) ?>"
