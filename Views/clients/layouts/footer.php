<footer class=" footer" style="background-color: #3b3a4a;margin-top: 170px; border-top:10px solid #F84E77">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-3 my-4">
                    ...
                    <div class="text-white-65 mb-4 text-white">Metor - UY TÍN TẠO NÊN CHẤT LƯỢNG</div>
    ...
    <div class="footer-bottom footer-border-top light py-3">
        <div class="container text-center">
            <p class="m-0">© 2021 copyright <a href="#" class="text-reset text-white">Metor.com.vn</a></p>
        </div>
    </div>
</footer>
